...
public class BittrexRequest {
    ...
    public BittrexRequest(String requestUrl)  throws BittrexApiException {

        this.requestUrl = requestUrl;
        try {
            url = new URL(requestUrl);
        } catch (MalformedURLException e) {
            throw new BittrexApiException("Mailformed URL " + e.getMessage());
        }
     ...
     */
    public BittrexRequest connect() throws BittrexApiException {
        ...
        try {
            ...
            throw new BittrexApiException("SSL Error " + e.getMessage() );
        } catch (KeyManagementException e) {
            throw new BittrexApiException("Key Management Error " + e.getMessage() );
        }

        try {
            conn = (HttpsURLConnection)url.openConnection();
        } catch (IOException e) {
            throw new BittrexApiException("HTTPS Connection error " + e.getMessage());
        }

        try {
            conn.setRequestMethod(method);
        } catch (ProtocolException e) {
            throw new BittrexApiException("HTTP method error " + e.getMessage());
        }
     ...
     * @throws BittrexApiException in case of any error
     */
    public BittrexRequest read() throws BittrexApiException {
        if (conn == null) {
            connect();
        }
        try {
            ...
            throw new BittrexApiException("Error in reading response " + e.getMessage());
        }
        return this;
    }

    public BittrexRequest payload(JsonObject payload) {
